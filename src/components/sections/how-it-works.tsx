        ...
        <div className="relative mt-16 grid gap-6 lg:grid-cols-3">
          ...
          {siteConfig.howItWorks.map((step, index) => (
            <Reveal key={step.step} delay={index * 100}>
              <article className="relative h-full rounded-[1.5rem] border border-slate-200 bg-slate-50 p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-brand-blue/10">
                ...
                <h3 className="mt-8 text-2xl font-bold text-brand-ink">{step.title}</h3>
